...
const FAQ = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "Cuando necesites asistencia, solo tienes que comunicarte con nosotros. Buscaremos al especialista adecuado y lo enviaremos con la mayor prontitud posible. Asegúrate de abonar el servicio para recibir la asistencia.",
    },
    {
      question: "¿A qué número llamo ante una emergencia?",
      answer:
        "En caso de emergencia, puedes comunicarte con nosotros las 24 horas al siguiente número: 0810-268-3762 / (011) 6009-6463. Para atención al cliente, el horario es de 10 a 18 hs.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "No, el servicio está destinado exclusivamente a reparaciones dentro del domicilio declarado por el cliente, dentro del territorio argentino.",
    },
  ];
    ...
    <section id="faq" className="faq section">
      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-lg-8 col-md-10" data-aos="fade-up" data-aos-delay="100">
            <div className="faq-container">
              {faqData.map((faq, index) => (
                ...
                >
                  ...
                  <i className={`faq-toggle bi bi-chevron-right ${activeIndex === index ? "rotated" : ""}`}></i>
                </div>
              ))}
            </div>
          </div>
